...
// Try grabbing the PORT and HOST variables from the environment, or use localhost:6160 as a default.
const PORT = process.env.PORT ? parseInt(process.env.PORT, 10) : 6160;
